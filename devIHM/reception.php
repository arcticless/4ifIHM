      ...
      <div class="row-fluid" style="padding-right:-50px">
		...
		<div class="span3" style="float:right;">
          <div class="sidebar-nav" >
			<ul class="nav nav-list" style="margin-top:-20px; text-align:center;"><a href="signature.php" class=" btn ">
			 <li style="margin-top:0px;"><p style="font-size:18px"><b>Signature<br/></b>Colis livré avec succès</p></li>
			  </a>
			</ul>
