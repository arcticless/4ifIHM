    ...
    <div class="container-fluid" >
      <div class="row-fluid" style="padding-right:-50px">
		...
		<div class="span3" style="float:right;">
		  ...
		  <p class="" style="font-size:15px;text-align:center;margin-top:-20px;"><b>Vous êtes au<br/></b>33 avenue Albert Einstein 69100 Villeurbanne</p>
			<ul class="nav nav-list " style="margin-top:00px; text-align:center;"><a href="reception.php" class=" btn btn-primary btn-large">
			 <li style="margin-top:0px;"><p style="font-size:20px"><b>Réception<br/></b><span style="font-size:12px">Aucun problème n'est survenu</span></p></li>
			  </a>
			</ul>
