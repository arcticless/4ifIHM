...
<head>
	...
	<link rel="stylesheet" href="routine_machine/leaflet-routing-machine.css" />
    ...
    <div class="container-fluid" >
      <div class="row-fluid" style="padding-right:-50px">
        ...
        <div class="span10" style="background:#FFF;">
          <div class="hero-unit iframe-responsive-wrapper" style="height:350px;">
		  <iframe id="respIframe" src="http://www.instantstreetview.com/2kgw0hz3i6vvxz3i0zpcz2u"><p>Not supported</p></iframe>
		...
		<div class="span3" style="float:right;">
		  ...
		  <p style="font-size:15px;text-align:center;margin-top:-20px;"><b>Heure de passage : </b><br/><span style="font-size:24px">9h46</span></p>

            <ul class="nav nav-list">
              <li style="margin-top:15px;"><p><a href="index.php" style="float:right;width:80%" class="btn btn-primary btn-large">Retour livraison...</a></p></li>
